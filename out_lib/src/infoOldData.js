...
define(function (require, exports, module) {"require:nomunge,exports:nomunge,module:nomunge";
    var $ = require('http://a.myhd.wumeiwang.com/out_lib/dist/sea_jquery.js');
            ...
            var _setInterval = setInterval(function () {
                ...
                if (_data&&_data.Id) {
                    ...
                    _info.find("img").each(function () {
                        ...
                        $this.attr("src", "http://a.myhd.wumeiwang.com/hdgw/view/public/img/pit.png");
                        $this.addClass("lazyload");
                    });
                    _info = _info.html();
                    $.ajax({
                        url: "http://l.hdgw.com/api/init/setProdct",
                        data: {
                            Id: _data.Id,
                            Info: _info
                        },
