define(function (require, exports, module) {
    ...
    var $ = require("http://a.myhd.wumeiwang.com/hdgw/model/lib/jquery/seajs-jquery-1.8.3.min.js"),
		...
		forimg = require("http://a.myhd.wumeiwang.com/hdgw/model/wmforimg/dist/forimg.js"),
		verification = require("http://a.myhd.wumeiwang.com/hdgw/model/wmverification/dist/wmverification.js"),
		top_data = require('http://a.myhd.wumeiwang.com/hdgw/view/ago/public/wm_top_data/dist/top_data.js'),
		module_juicer = require("http://a.myhd.wumeiwang.com/hdgw/view/sns/public/wm_sns_juicer/dist/module_juicer.js"),
		modules = require("http://a.myhd.wumeiwang.com/hdgw/view/sns/public/wm_sns_juicer/dist/modules.js"),
		inquire = require('http://a.myhd.wumeiwang.com/hdgw/view/sns/public/wm_inquire/dist/inquire.js'),
		lazyload = require('http://a.myhd.wumeiwang.com/hdgw/model/wmlazyload/dist/wmlazyload.js'),
		friends = require('http://a.myhd.wumeiwang.com/hdgw/view/sns/public/wm_friends/dist/friends_relation.js')
    ;
                            ...
                            if (_title.val() && editor.getContent()) {
                                modules.Iask({
                                    ...
                                    success: function (data) {
                                        if (data.success) {
                                            self.hide();
                                            window.location.href = "http://sns.hdgw.com/answer_question/question/detail?" + $.param({
