define(function(require,exports,module){
	...
	var $ = require("http://a.myhd.wumeiwang.com/hdgw/model/lib/jquery/seajs-jquery-1.8.3.min.js"),
		...
		page = require("http://a.myhd.wumeiwang.com/hdgw/model/wmpage/dist/wmpage.js")
	;
	...
	// 用户信息
	 _ownerHtml = juicer([
		...
		'<ul class="owner_infor">',	
			'<li class="owner_infor_item" data_count_url="http://sns.hdgw.com/shop/sns/reshoppinglistnum"><a href="#" data_hostid="${hostId}">转载<span class="owner_infor_num">0</span></a></li>',
			'<li class="owner_infor_item" data_count_url="http://sns.hdgw.com/friends/friend/t"><a href="http://sns.hdgw.com/friends/friend/fd?hostId=${hostId}">好友<span class="owner_infor_num">0</span></a></li>',
			'<li class="owner_infor_item" data_count_url="http://sns.hdgw.com/shop/sns/shoppinglistnum"><a href="http://sns.hdgw.com/shop/sns/shoppingdetaillist?hostId=${hostId}">购物经<span class="owner_infor_num">0</span></a></li>',
			'<li class="owner_infor_item" data_count_url="http://sns.hdgw.com/answer_question/question/t"><a href="http://sns.hdgw.com/answer_question/question/getallquestion?hostId=${hostId}">问答<span class="owner_infor_num">0</span></a></li>',
			'<li class="owner_infor_item" data_count_url="1"><a href="#" data_hostid="${hostId}">推荐<span class="owner_infor_num">0</span></a></li>',
			'<li class="owner_infor_item" data_count_url="http://sns.hdgw.com/answer_question/mark/t"><a href="http://sns.hdgw.com/answer_question/mark/list?hostId=${hostId}">MARK<span class="owner_infor_num">0</span></a></li>',
		'</ul>'
	].join(''));
	var getOwnerData=function(callback){
		$.ajax({
			...
			error:function(){
				var $owner;
				/*var _data = {
					headImg:"http://a.myhd.wumeiwang.com/hdgw/view/sns/public/img/head_img.jpg",
					user_id:"1",
					user_name:"利威尔兵长",
					bang:[
						{
			...
			$.ajax({
				...
				error:function(){
					/*var data = {
						lists:[
							{
								headImg:"http://a.myhd.wumeiwang.com/hdgw/view/sns/public/img/head_40_40.jpg",
								user_id:"1",
								user_name:"艾伦·耶格尔",
								bang:[
									{
		...
		$.ajax({
			...
			error:function(){
				var data = {
					imglist:[
						{
							imgCon:"http://a.myhd.wumeiwang.com/hdgw/view/sns/public/img/head_img.jpg"	
						},
						{
							imgCon:"http://a.myhd.wumeiwang.com/hdgw/view/sns/index/img/img_200_160.jpg"	
						},
						{
							imgCon:"http://a.myhd.wumeiwang.com/hdgw/view/sns/public/img/head_40_40.jpg"	
						}
					]	
				};
