define(function (require, exports, module){
	...
	;
	require("http://a.myhd.wumeiwang.com/hdgw/view/sns/public/wm_reshipment/css/style.css");
	...
	_reshipment = function(op){
		...
		$.ajax({
			...
			success:function(data){
				var $con = $('<div class="reship_con"><p class="reship_tip"><span class="wm_ico hook8"></span>转载成功！</p><div class="reship_btns"><a href="#" class="stay">继续浏览</a><a href="http://sns.hdgw.com/sns/shoppingdetaillist?hostId='+global_setting.hostId+'" class="view" target="_blank">查看详情</a></div><a href="#" class="wm_ico fork7 close"></a></div>');
				_box.setCon($con);
