        ...
        '<tr data_id="${item.id}" data_name="${item.name}" data_remark="${item.remark}">',
            ...
            '<td>',
                '<div class="btn_list">',
                    ...
                    '</ul>',
                    '{@else}',
                    '<a href="http://y.hdgw.com/module/page?search_model_name=${item.name}&search_model_id=${item.id}" class="ui_btn ui_btn_h23yellow8 portal"><span class="ui_btn_txt">页面设置<span class="wm_ico arrow6down"></span></span></a>',
                    '<ul>',
                        '<li class="btn_list_last">',
                            '<a href="http://y.hdgw.com/module/page?search_model_name=${item.name}&search_model_id=${item.id}" class="">页面设置</a>',
                        '</li>',
                        '<li>',
                            '<a href="#" class="edit_model">修改</a>',
                        '</li>',
