define(function (require, exports, module) {
    ...
    var _addModel = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/add",
            data: {
    ...
    var _editModel = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/modify",
            data: {
                id: op.id,
                name: op.name,
                remark: op.remark
    ...
    var _delModel = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/delete",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _addNavNode = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/addnode",
            data: {
                parentid: op.parent_id || "",
                name: op.name,
                remark: op.remark
    ...
    var _editNavNode = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/modifynode",
            data: {
                id: op.id,
    ...
    var _delNavNode = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/deletenode",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _editRole = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/role/modify",
            data: {
                id: op.role_id,
                name: op.role_name,
                remark: op.role_remark
    ...
    var _roleEditCompetence = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/role/privilege",
            data: {
                roleId: op.roleId,
                asList: op.asList
            },
    ...
    var _delRole = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/role/delete",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _addPage = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/addpage",
            data: {
                classId: op.modelId || "",
                name: op.name,
                url: op.url,
    ...
    var _editPage = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/modifypage",
            data: {
                id: op.id,
                classId: op.modelId,
                name: op.name,
    ...
    var _delPage = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/deletepage",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _editGroup = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/group/modify",
            data: {
                id: op.group_id,
                name: op.group_name,
                remark: op.group_remark
    ...
    var _roleToGroup = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/group/setrole",
            data: {
                groupId: op.groupId,
                roleIds: op.roleIds
            },
    ...
    var _groupToAcc = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/employee/setgroup",
            data: {
                accId: op.accId,
    ...
    var _pageAddCompetence = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/add",
            data: {
                module_id: op.pageId,
                name: op.name,
                remark: op.remark
    ...
    var _pageEditCompetence = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/modify",
            data: {
                id: op.id,
                name: op.name,
                remark: op.remark
    ...
    var _pageDelCompetence = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/delete",
            data: {
    ...
    var _getPageCompetenceList = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/list",
            data: {
                module_id: op.id
            },
            dataType: "json",
    ...
    var _rePassWord = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/employee/repassword",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _addAcc = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/employee/add",
            data: {
                account: op.account,
                name: op.name
            },
    ...
    var _disabledAcc = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/employee/forbid",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _openAcc = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/employee/use",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _delAcc = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/employee/delete",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _getModelDetail = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/getchild",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _getModelPageList = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/getpage",
            data: {
                id: op.id
            },
            dataType: "json",
    ...
    var _getGroupList = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/group/list",
            data: {},
            dataType: "json",
            type: "get",
            success: function (data) {
    ...
    var _getModelTree = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/module/tree",
            data: {},
            dataType: "json",
            type: "get",
            success: function (data) {
    ...
    var _getNavTree = function (op) {
        $.ajax({
            url: "http://y.hdgw.com/privilege/tree",
            data: {},
            dataType: "json",
            type: "get",
            success: function (data) {
