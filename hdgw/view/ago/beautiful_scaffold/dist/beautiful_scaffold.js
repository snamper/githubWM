                ...
                '<div class="fun_list">',
                    ...
                    '<fieldset  class="fun_item">',
                        ...
                        '<div class="min_blog_list">',
                            '<a href="#" class="wm_ico tx_wb32_32 min_blog" data_type="tx" data_title="刚刚在互动购物看到了这个商品，挺不错的，小伙伴们快来买吧~" data_pic="${dataPic}" data_url="${userLink}" target="_blank"></a>',
                            '<a href="#" class="wm_ico sina_wb32_32 min_blog" data_type="sina" data_title="刚刚在互动购物看到了这个商品，挺不错的，小伙伴们快来买吧~" data_pic="${dataPic}" data_url="${userLink}" target="_blank"></a>',
                        '</div>',
                    '</fieldset>',
                '</div>',
            '</div>'
