                    ...
                    fun: function () {
                        ...
                        setTimeout(function () {
                            $lady.find(".lady_item").each(function () {
                                ...
                                $brand_list.append('<li class="brand_item"><a target="_blank" href="' + (_data_sid ? ("http://item.hdgw.com/merchant/list/" + _data_sid) : "javascript:void(0);") + '"><img src="' + ($this.find("a").attr("data_logo") || "http://a.myhd.wumeiwang.com/hdgw/view/ago/wmwomen/img/404logo.png") + '"></a></li>');
                            });
                        }, 300);
                    }
                },
