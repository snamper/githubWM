define(function (require, exports, module) {
    ...
    var _evaluateItem = juicer([
        ...
        '<li class="comment_item">',
            ...
            '<div class="item_data user_data">',
                ...
                '<span class="user_ico">',
                   '<img title="VIP${item.Level}" src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/LVIMGV1/vip${item.Level}.png">',
                '</span>',
            '</div>',
        '</li>',
        '{@/each}'
    ...
    var init = function () {
        ...
        $body.append('<div id="big_move" style="display: none;width: 200px;height: 200px;position: absolute;top:0;left:0;cursor: move;background: url(http://a.myhd.wumeiwang.com/hdgw/view/public/img/mask1.png) 0 0 repeat;"></div>');
