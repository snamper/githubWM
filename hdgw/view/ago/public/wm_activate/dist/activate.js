                        ...
                        '<div class="head_top_bb1f">',
                            '<div class="sub_head_top">',
                                ...
                                '<div class="class_list">',
                                    ...
                                    //    '<li>',
                                    //        '<img src="http://img.hdgw.com/M00/00/5D/rBAA_lMNTyeALkn6AAAI0kqtW8g217.jpg" /><a href="#">服饰箱包</a></li>',
                                    //    '<li>',
                                    //        '<img src="http://img.hdgw.com/M00/00/5D/rBAA_lMNTyeALkn6AAAI0kqtW8g217.jpg" /><a href="#">服饰箱包</a></li>',
                                    //    '<li>',
                                    //        '<img src="http://img.hdgw.com/M00/00/5D/rBAA_lMNTyeALkn6AAAI0kqtW8g217.jpg" /><a href="#">服饰箱包</a></li>',
                                ...
                                '<div class="pull_btns">',
                                    ...
                                    '<ul class="pull_list">',
                                        '<li>',
                                            '<a href="#" class="pull_link">我的互动</a><span class="pull_arrow "><em>◆</em><span>◆</span></span>',
                                        '</li>',
                                        '<li>',
            ...
            case "2":
                ...
                $head_top.replaceWith([
                   '<div class="head_top"><div class="head_top_bb1f"><div class="sub_head_top">',
                       ...
                       '</div>',
                       '<div class="link_list">',
                           '<a href="' + domains.sell + '">商家首页</a><em>|</em><a href="' + domains.item + '/merchant/list/' + lib.cookie("wm.user.id") + '">我的店铺</a><em>|</em><a href="http://a.myhd.wumeiwang.com/wmactivity/merchants_v1/index.html" target="_blank">招商启事</a><em>|</em><a href="' + domains.sell + '/order/list" title="待发货订单">订单管理</a><b></b><em>|</em><a href="' + domains.sell + '/order/list" title="退款申请">退款申请</a><b></b><em>|</em><a href="' + domains.item + '/product">商品上架</a>',
                       '</div>',
                   '</div></div></div>'
                ].join(''));
                getUserData(function (data) {
                    var $user_data = $page.find(".head_top .user_data");
                    $user_data.append('<img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/LVIMGV1/lv' + data.response.Level + '.png" title="' + busLvTitle[data.response.Level] + '" style="vertical-align: middle; margin: 0 10px" />');
