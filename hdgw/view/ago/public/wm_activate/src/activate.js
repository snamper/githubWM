define(function (require, exports, module) {
    ...
    var $ = require("http://a.myhd.wumeiwang.com/hdgw/model/lib/jquery/seajs-jquery-1.8.3.min.js"),
        ...
        area = require("http://a.myhd.wumeiwang.com/hdgw/model/wmarea/dist/wmarea.js"),
    ...
    var init = function () {
        ...
        if (_active_phone) {
            ...
            if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM) {
                window.location.href = "http://m.hdgw.com/ipt/reg?" + $.param({ active_phone: _active_phone, sign: _sign });
            }
            //if (lib.cookie("wm.user.username") && (lib.cookie("wm.user.username") !== ("hdgw_" + _active_phone))) {
            //    return false;
            //}
            ...
            var _initBuyAttr = function (data) {
                return juicer([
                    '<form class="wm_form post_gifts_form" action="http://m.hdgw.com/present/pre_order">',
                       '<ul>',
            ...
            var _initGiftsList = function (data) {
                return juicer([
                    '<div class="puab_head">',
                        '<h3 title="互动购物" class="iconfont">&#xe624;</h3>',
                        '<div class="logo_msg"><em>互动购物</em><span>HU DONG GOU WU</span></div>',
                            ...
                            'content': [
                                ...
                                '<div class="puab_main">',
                                    ...
                                    '<ul class="wm_form act_form">',
                                        ...
                                        '</li>',
                                        '<li class="form_row">',
                                            '<label class="row_key">密码：</label><input type="password" class="form_txt w170 password" value="hdgw888888" wmv="loginpassword" wmvmsg="请输入6-16位，字符" />',
                                            '<span class="remark">默认：hdgw888888</span>',
                                        '</li>',
                                                ...
                                                if (data.response.result) {
                                                    self.setCon(juicer([
                                                        ...
                                                        '<div class="success_box">',
                                                            ...
                                                            '<p>进入<a href="http://www.hdgw.com/">互动购物</a></p>',
                                                            '<p>${commname}</p>',
