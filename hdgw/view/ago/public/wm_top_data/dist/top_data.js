            ...
            $head_top.replaceWith([
                    '<div class="head_top"><div class="head_top_bb1f"><div class="sub_head_top">',
                        ...
                        '<div class="pull_btns w115 followwm">',
                            '<a href="#" class="idea w115"><i class="wm_ico heart1"></i>关注物美<span class="pull_arrow "><em>◆</em><span>◆</span></span></a>',
                            '<ul class="pull_list w115">',
                                '<li><a href="#" class="pull_link"><i class="wm_ico heart1"></i>关注物美</a><span class="pull_arrow "><em>◆</em><span>◆</span></span></li>',
                                ...
                                '<li><a href="#" class="pull_link"><i class="social_icon wumeibang"></i>物美帮</a></li>',
                            '</ul>',
                        '</div>',
                        ...
                        '</div>',
                        '<div class="link_list">',
                            '<a href="http://a.myhd.wumeiwang.com/wmactivity/merchants_v1/index.html" target="_blank">招商启事</a><em>|</em><a href="#" class="add_favorite">收藏本站</a><em>|</em><a href="http://help.wumeiwang.com/wmmode.html">帮助中心</a>',
                        '</div>',
                    '</div></div></div>'
            ].join(''));
        };
                    ...
                    '<div class="head_top">',
                        '<div class="head_top_bb1f">',
                            '<div class="sub_head_top">',
                                ...
                                '</div>',
                                '<div class="pull_btns">',
                                    '<a href="#" class="idea">我的物美<span class="pull_arrow "><em>◆</em><span>◆</span></span></a>',
                                    '<ul class="pull_list">',
                                        '<li>',
                                            '<a href="#" class="pull_link">我的物美</a><span class="pull_arrow "><em>◆</em><span>◆</span></span>',
                                        '</li>',
                                        '<li>',
