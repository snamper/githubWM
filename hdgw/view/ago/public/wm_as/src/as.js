...
define(function (require, exports, module) {
    ...
    require('http://a.myhd.wumeiwang.com/hdgw/view/ago/public/wm_as/css/style.css');
    ...
    var init = function (op) {
        ...
        if (lib.queryString("is_as_locate")) {
            $page.find(".wm_as_pit").append('<div class="wm_as_mask"><a class="nail" href="#" title="定位"><img src="http://a.myhd.wumeiwang.com/hdgw/view/ago/public/wm_as/img/nail.png" style="width:100px;height:100px"></a></div>')
        }
