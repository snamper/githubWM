define(function (require, exports, module) {
		...
		var bind=function(){
			...
			var vTwoDomain = function (callback) {
				if (!_invBox) {
					_invBox = box.invBox({
						content: '<p style="text-align: center;line-height: 70px;"><img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/loading/loading18_18_1.gif" style="vertical-align: middle;" /> 正在检测二级域名是否可用！</p>',
						btns: []
					});
				}
				_invBox.show();
