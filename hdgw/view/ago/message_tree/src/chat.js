            ...
            friend.getUserFriend({
                ...
                success: function (data) {
                    ...
                    for (var i in data.success.users) {
                        arr.push('<li class="friends_list_item"><a href="http://sns.hdgw.com/message/dialogue/cath?receiverId=' + data.success.users[i].userId + '" class="friends_infor"><img src="' + (data.success.users[i].avatar || "http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg") + '">' + data.success.users[i].userName + '</a></li>')
                    }
                        ...
                        data_list: [
							{
							    ...
							    subList: [
									{
									    imgurl: "http://a.myhd.wumeiwang.com/hdgw/view/buyers/message_tree/img/bg1.jpg",
									    id: "12"
									},
									{
									    imgurl: "http://a.myhd.wumeiwang.com/hdgw/view/buyers/message_tree/img/title-bg-female.jpg",
									    id: "012"
									},
									{
									    imgurl: "http://a.myhd.wumeiwang.com/hdgw/view/buyers/message_tree/img/bg1.jpg",
							...
							},
							{
							    ...
							    subList: [
									{
									    imgurl: "http://a.myhd.wumeiwang.com/hdgw/view/buyers/message_tree/img/bg2.jpg",
									    id: "12"
									},
									{
									    imgurl: "http://a.myhd.wumeiwang.com/hdgw/view/buyers/message_tree/img/bg1.jpg",
