            ...
            '<li class="commodity_item waterfall_item">',
                '<div class="lazyload_img_bg">',
                    '<a href="/product/view/${item.id}" target="_blank">',
                        '<img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/pit.png" lazyload_url="${item.ProductImgDefault}" class="lazyload" lazyload="t" />',
                    '</a>',
                '</div>',
