        ...
        verification.addRule([
            {
                key: "crowd_type",
                fun: function () {
                    return !!_postData.protagonistId;
                }
            },
            {
                key: "crowd_face",
                fun: function () {
                    return $(".group_face_img").attr("src") !== "http://a.myhd.wumeiwang.com/hdgw/view/public/img/pit.png";
                }
            }
        ]);
        bind();
    ...
    var bind = function () {
            ...
            '<div class="group_face_main sys">',
                ...
                '<div class="preview">',
                    '<ul class="preview_list">',
                        '<li class="preview_item"><span class="img_bg p80_80"><img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/pit.png"></span><p class="remark">80 * 80</p></li>',
                        '<li class="preview_item"><span class="img_bg p60_60"><img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/pit.png"></span><p class="remark">60 * 60</p></li>',
                    '</ul>',
                '</div>',
                '<div class="sys">',
                    '<ul class="sys_face_list">',
                        '<li><span class="img_bg"><img src="http://isdimg2.qq.com/club/item/face/img/4/12294.gif"></span></li>',
                        '<li><span class="img_bg"><img src="http://isdimg2.qq.com/club/item/face/img/4/12294.gif"></span></li>',
                        '<li><span class="img_bg"><img src="http://isdimg2.qq.com/club/item/face/img/4/12294.gif"></span></li>',
                        '<li><span class="img_bg"><img src="http://isdimg2.qq.com/club/item/face/img/4/12294.gif"></span></li>',
                        '<li><span class="img_bg"><img src="http://isdimg2.qq.com/club/item/face/img/4/12294.gif"></span></li>',
                ...
                '<div class="custom">',
                    '<div class="img_bg">',
                        ...
                        '<img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/pit.png">',
        ...
        $page.on("click", ".submit", function () {
            ...
            if (verification.verify($create_crowd)) {
                ...
                var postData = {
                    //社团名称
                    crowd_name: $page.find(".crowd_name").val(),
                    //社团主要类型
                    protagonistId: _postData.protagonistId,
                    protagonistName: _postData.protagonistName,
                    //社团次要类型
                    supportingIds: _postData.supportingIds,
                    supportingNames: _postData.supportingNames,
                    //社徽
                    group_face_: $group_face_img.attr("src"),
                    //社团简介
                    introduction: $page.find(".introduction").val(),
                    //标签
                    tag_list: JSON.stringify(_tag_list),
                    //邀请的好友
                    friends: JSON.stringify(_friend_list)
                };
                $.ajax({
                    url: "",
                    dataType: "jsonp",
