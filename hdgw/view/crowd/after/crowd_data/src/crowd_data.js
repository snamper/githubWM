define(function (require, exports, module) {
    ...
    var _postData = {};
    var init = function () {
        _postData.protagonistId = global_setting.mainCategory;
        _postData.protagonistName = global_setting.mainCategoryName;
        _postData.supportingIds = global_setting.minorCategory;
        _postData.supportingNames = global_setting.minorCategoryNames;
    ...
    var bind = function () {
        ...
        $page.on("click", ".chk_type_box", function () {
            ...
            if (!typeBox) {
                typeBox = crowd_type.showBox({
                    success: function () {
                        this.selSelect(global_setting.mainCategory);
                        this.chkSubType(global_setting.minorCategory);
                    },
        ...
        $page.on("click", ".submit", function () {
            ...
            if (verification.verify($create_crowd)) {
                ...
                $.ajax({
                    url: domains.commune + "/asyn/commune/submit_edit.json",
