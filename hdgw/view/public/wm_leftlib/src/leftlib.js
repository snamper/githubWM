                    ...
                    '<ul>',
                        '<li>',
                            '<a href="#" class="follow_wx" rel="nofollow">',
                                '<img class="ewm_img" src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/dimensional_code.jpg" width="100" height="100"></a>',
                        '</li>',
                        '<li>',
                            '<a href="http://weibo.com/2358731552/profile?topnav=1&amp;wvr=5&amp;from=company&amp;user=1" class="follow_sina" target="_blank" rel="nofollow">',
                                '<img class="ewm_img" src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/sina_dimensional_code.png" width="100" height="100"></a>',
                        '</li>',
                    '</ul>',
        ...
        '<div class="ll_user_data_box">',
            '<div class="ll_user_data_con">',
                ...
                '<ul>',
                    ...
                    '<li>排名：<b>${rank}</b></li>',
                    '<li class="shopping_statistics">您在互动购物上花掉<b>${spend}</b>元，总共收了<b>${parcel_sun}</b>个包裹</li>',
                '</ul>',
        ...
        '<div class="ll_user_data_box seller">',
            '<div class="ll_user_data_con ">',
                ...
                '<ul>',
                    ...
                    '<li class="shopping_statistics">您在互动购物上赚了<b>${profit}</b>元，总共发出<b>${parcel_sun}</b>个包裹</li>',
                '</ul>',
                '<a href="' + domains.account + '/logout" class="ll_logout">退出</a>',
            '</div>',
            '<span class="ll_arrow "><em>◆</em><span>◆</span></span>',
        ...
        '<div class="ll_user_data_box">',
            '<div class="ll_user_data_con">',
                '<a href="javascript:void(0);" class="ll_user_img" title="${user_name}"><span class="ll_user_img_bg">',
                    '<img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg"></span></a>',
                '<ul>',
                    '<li class="ll_user_data_name" title="${user_name}">Hi,${user_name}</li>',
                '</ul>',
                '<a href="' + domains.account + '/logout" class="ll_logout">退出</a>',
                        ...
                        var data = {
                            itemList: [
                                ...
                                },
                                {
                                    title: '我爱互动购物',
                                    get_date: '1989-06-06',
                                    msg: '在互动购物浏览<b>10分钟</b>，获得<b>30</b>积分！'
                                },
                                {
                                    title: '风雨弄潮儿',
                                    get_date: '1989-06-06',
                                ...
                                },
                                {
                                    title: '物美传教士',
                                    get_date: '1989-06-06',
                                    msg: '成功邀请<b>xxx</b>成为互动购物会员，获得<b>30</b>积分！'
                                }
                            ]
                        };
