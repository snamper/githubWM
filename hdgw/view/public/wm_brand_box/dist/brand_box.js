define(function (require, exports, module) {
    ...
    require('http://a.myhd.wumeiwang.com/hdgw/view/public/wm_brand_box/css/style.css#');
    var gData = {}, brandsBox;
            ...
            '<div class="confirm_brands_mian">',
                ...
                '<ul class="brands_list">',
                    '<li style="border: 0; width: 720px;">',
                        '<span class="pipes_bg" style=" background: url(http://a.myhd.wumeiwang.com/hdgw/view/public/img/pipes.png) 0 0 no-repeat; width: 181px; height: 11px; display: block; vertical-align: text-top; margin: 0 auto;text-align: left;"><span class="pipes_water" style="background: url(http://a.myhd.wumeiwang.com/hdgw/view/public/img/pipes.png) 0 -40px no-repeat; width: 0%; height: 11px; display: inline-block; vertical-align: top;"></span></span>',
                    '</li>',
                '</ul>',
            '</div>'
            ].join('')).render(gData);
