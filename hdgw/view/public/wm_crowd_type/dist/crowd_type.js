...
define(function (require, exports, module) {
    ...
    _delCommodityTag = function (op) {
        $.ajax({
            url: domains.www+'/sell/deleteTag',
            type: 'get',
            dataType: 'jsonp',
            data: {
                tagId: op.tagId
    ...
    _businessToTag = function (op) {
        $.ajax({
            url: domains.www+'/sell/favoritetotag',
            type: 'get',
            dataType: 'jsonp',
            data: {
                tagId: op.tagId,
    ...
    _businessOutTag = function (op) {
        $.ajax({
            url: domains.www+'/sell/favorouttag',
            type: 'get',
            dataType: 'jsonp',
            data: {
                tagId: op.tagId,
    ...
    _getCommodityTagList = function (op) {
        $.ajax({
            url: domains.www+'/sell/tag/getfavoritelist',
            type: 'get',
            dataType: 'jsonp',
            data: {
                flag: 0
   ...
   //获取分类列表
    _getGroupList = function (op) {
        $.ajax({
            url: domains.www+'/sell/tag/getgrouplist',
            type: 'get',
            dataType: 'jsonp',
            data: {
    ...
    _getCommodityItemTag = function (op) {
        $.ajax({
            url: domains.www+'/sell/gettaglist',
            type: 'get',
            dataType: 'jsonp',
            data: {
                favoriteId: op.id
