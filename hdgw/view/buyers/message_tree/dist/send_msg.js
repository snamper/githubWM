define(function (require, exports, module) {
    ...
    var _friendItemHtml = juicer([
        '<li class="friend_item" data_id="${id}" data_name="${name}" data_signature="${signature}">',
            '<a href="#" title="${name}">',
                '<img class="friend_img" src="${img}" />',
    ...
    var initFriend = function (data) {
        ...
        friend.getUserFriend({
            ...
            error: function () {
                var data = {
                    friendList: [
                        { id: "456", name: "dfsczxsdg", img: "http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg", signature: "签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名" },
                        { id: "456", name: "dfsczxsdg", img: "http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg", signature: "签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名" },
                        { id: "456", name: "dfsczxsdg", img: "http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg", signature: "签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名" },
                        { id: "456", name: "dfsczxsdg", img: "http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg", signature: "签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名" },
                        { id: "456", name: "dfsczxsdg", img: "http://a.myhd.wumeiwang.com/hdgw/view/public/img/man_default.jpg", signature: "签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名签名" },
                ...
                for (var i in data.friendList) {
                    _arr.push(_friendItemHtml.render(data.friendList[i]));
                }
                            ...
                            if (_v) {
                                ...
                                friend.getFriendData({
                                    success: function () {
                                        addUser({
                                            userName: _v,
                                            userId: parseInt(Math.random() * 999) + 999
                                        });
                                    },
                                    error: function () {
        ...
        $page.on("click", ".remove_user:not(.animate_in)", function () {
            ...
            if ($send_user_item.attr("data_img")) {
                $friendItem = $(_friendItemHtml.render({
                    id: $send_user_item.attr("data_id"),
                    name: $send_user_item.attr("data_name"),
                    img: $send_user_item.attr("data_img"),
