define(function (require, exports, module) {
    ...
    require('http://a.myhd.wumeiwang.com/hdgw/view/ago/public/wm_top_data/css/style.css#');
    var init = function () {
        ...
        if (tracknick) {
            $(".head_top .user_data").replaceWith('<div class="user_data"><span>欢迎加入互动购物：</span><a href="' + domains.member + '" style="color: #b10000">' + tracknick + '</a><a href="' + domains.account + '/logout" style="color: #b10000; margin-left: 10px; font-family: SimSun">[退出]</a></div>');
        }
        ...
        //    //    '3': "3级买手"
        //    //};
        //    //$user_data.append('<img src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/LVIMGV1/vip' + data.response.Level + '.png" title="' + buyLvTitle[data.response.Level] + '" style="vertical-align: middle; margin: 0 10px" />');
