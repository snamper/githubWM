                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            verificationBox.setCon('<p class="msg"><i class="wm_ico ban1" style="margin-right: 14px;"></i>不允许输入互动购物以外的URL，或者非商家本人的商品和店铺！<span class="remark">0秒后关闭</span></p>');
                            verificationBox.position();
                            lib.countdown({
                                parent: verificationBox.wmBox.find(".msg"),
                                ele: "#verification_box .remark",
