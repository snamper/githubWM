        ...
        var showAddSuccess = function (_id) {
            if (!successBox) {
                successBox = box.alert({
                    boxCls: "successmsg",
                    titleText: "上架成功",
                    content: '<p style="width: 500px;text-align: center;font-size: 14px; padding: 50px;line-height: 30px; font-family: simsun;"><b style="color:#e13436;font-weight: 500;">恭喜，您的商品已经成功上架！</b>您可以继续上架商品，或者进行其他操作在您发布10款商品后，互动购物将建立您的专属卖场</p>',
                    btns: [
                               //{
