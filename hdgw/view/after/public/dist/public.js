        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.response) {
                    ...
                    $page.find(".uesr_data_lv").empty().append('等级：<img title="' + busLvTitle[data.response.Level] + '" style="vertical-align: middle;" src="http://a.myhd.wumeiwang.com/hdgw/view/public/img/LVIMGV1/lv' + data.response.Level + '.png">')
                }
            },
            error: function () { }
        });
