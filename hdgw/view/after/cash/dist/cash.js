				...
				'<form action="" class="wm_form">',
					'<ul>',
						...
						'<li class="form_row">',
							...
							'</div>',
						'</li>',
						'<li class="form_row download_file"><a href="http://a.myhd.wumeiwang.com/hdgw/view/after/cash/物美商家个人卡使用授权书.zip" class="doc">下载《商家个人卡使用授权书.doc》</a> 注：下载打印填写，同时盖企业红章。在该页面上传授权书凭证照片！</li>',
