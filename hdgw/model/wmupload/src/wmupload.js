...
define(function (require, exports, module) {
    ...
    require('http://a.myhd.wumeiwang.com/hdgw/model/wmupload/css/style.css#');
    var wmupload = function () {
        ...
        this.upload = function (file, callback) {
            ...
            var _v = file.val();
            if (_v) {
                $up_loading = $('<div class="up_loading"><img src="http://a.myhd.wumeiwang.com/hdgw/model/wmupload/img/up_loading.png" title="文件正在上传"></div>');
